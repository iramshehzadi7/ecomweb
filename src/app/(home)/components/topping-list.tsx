...
const toppings = [
    { id: '1', name: 'Chicken', image: '/chicken.png', price: 49, isAvailable: true },
    { id: '2', name: 'jelapeno', image: '/Jelapeno.png', price: 49, isAvailable: true },
    { id: '3', name: 'Cheese', image: '/cheese.png', price: 49, isAvailable: true },
];
